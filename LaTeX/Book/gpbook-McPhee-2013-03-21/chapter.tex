...
individuals simply aren't able to solve.\marginpar{It would be interesting to explore the details
	of those error values, but not right now.}
...
we look at the total error for each individual along the (mostly) diamond path from 80220 through
82447 to 86261 (displayed in Table~\ref{table:winnerFitnesses}), the fitness of the first five
individuals in the chain aren't too surprising. One (individual 82447) has the best total error in
that generation, all the others are in or nearly in the top quarter of the population. The fitnesses 
...
\emph{Say something about individual 86261.}
