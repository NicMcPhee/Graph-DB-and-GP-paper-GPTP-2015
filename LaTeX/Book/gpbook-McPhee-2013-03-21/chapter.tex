...
``priviledged'' position of being able to collect anything and everything that happens in a run, 
...
infeasible. In exploring the dynamics of an EC run, we're going to want to be able to
