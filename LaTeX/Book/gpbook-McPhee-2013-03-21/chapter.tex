...
The data we explored in this chapter is a subset of the data collected for \citep{Helmuth:2015:GPTP}. In particular
...
beyond the scope of this chapter. It is possible, however, and our graph database analysis has clearly
...
factor in this ancestor is much higher than with lexicase in Figure~\ref{fig:winnerAncestors}. 
Table~\ref{table:branching} shows 
the number of ancestors $n$ generations back that contributed the winning individual, and we can
...
tournament as lexicase. This is likely
